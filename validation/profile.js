...
//         errors.handle = 'Handle field needs required'
//     }
//     if(Validator.isEmpty(data.status)){
//         errors.status = 'Status field needs required'
//     }
//     if(Validator.isEmpty(data.skills)){
//         errors.skills = 'Skills field needs required'
//     }
//
...
//             errors.skills = 'youtube is invalid'
//     }
//
//
//
